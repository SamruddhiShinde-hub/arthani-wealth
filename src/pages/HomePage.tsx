...
import { Calculator, Target, Shield, Zap, ArrowRight, CheckCircle, Circle, Home } from 'lucide-react';
...
export default function HomePage({ setCurrentPage }: HomePageProps) {
  return (
    <div>
      ...
      <section className="bg-gradient-to-r from-emerald-600 to-teal-600 text-white py-6">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
          	...
          	<button
		              onClick={() => setCurrentPage('financial-clarity')}
		              className="px-8 py-3 bg-emerald-700 text-white rounded-full font-semibold hover:bg-emerald-800 transition-all border-2 border-emerald-400"
		            >
            ...
            <button
              ...
              className="px-8 py-3 bg-transparent text-white border-2 border-white rounded-full font-semibold hover:bg-white hover:text-emerald-600 transition-all"
            >
              Learn More
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          {/* Financial Clarity Check */}
	              ...
	              >
	                ...
	                <h3 className="text-xl font-bold mb-2 text-gray-800">Clarity Check</h3>
	                <p className="text-gray-600 mb-4">Assess your financial health in 7 minutes</p>
      ...
      {/* Featured Section - Financial Clarity */}
      <section className="py-6 bg-gradient-to-r from-emerald-600 to-teal-600 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
              <h2 className="text-3xl font-bold mb-4">Are You Truly Financially Sorted?</h2>
              <p className="text-emerald-100 mb-6 text-lg">
                Take our comprehensive 7-minute wealth clarity check designed for corporate leaders 
                and senior professionals. Get your financial clarity score and personalized recommendations.
              </p>
              <button
                onClick={() => setCurrentPage('financial-clarity')}
                className="px-8 py-3 bg-white text-emerald-600 rounded-full font-bold hover:shadow-2xl transition-all"
              >
            ...
            <div className="flex-1 flex justify-center">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 text-center">
                <Shield className="mx-auto mb-4 text-emerald-200" size={64} />
                <div className="text-4xl font-bold mb-2">15 Questions</div>
                <div className="text-emerald-200 mb-4">5 Critical Areas</div>
                <div className="space-y-2 text-sm text-left">
                  <div className="flex items-center gap-2">
                    <CheckCircle size={16} className="text-emerald-300" />
                    <span>Financial Clarity & Net Worth</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <CheckCircle size={16} className="text-emerald-300" />
                  ...
                  <div className="flex items-center gap-2">
                    <CheckCircle size={16} className="text-emerald-300" />
                    <span>Tax & Wealth Structuring</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-6 bg-gradient-to-r from-emerald-600 to-teal-600 text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            ...
            <button
              onClick={() => setCurrentPage('financial-clarity')}
              className="px-10 py-4 bg-emerald-700 text-white border-2 border-emerald-400 rounded-full font-bold text-lg hover:shadow-2xl transition-all"
            >
